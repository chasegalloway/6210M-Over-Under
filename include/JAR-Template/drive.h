...
public: 
  ...
  float clamped_drive_output;

  float clamped_heading_output;
  ...
  void set_drive_constants_velocity(float drive_max_velocity, float drive_kp, float drive_ki, float drive_kd, float drive_starti);
  ...
  void drive_distance_velocity(float distance);
  void drive_distance_velocity(float distance, float heading);
  void drive_distance_velocity(float distance, float heading, float drive_max_velocity, float heading_max_velocity);
  void drive_distance_velocity(float distance, float heading, float drive_max_velocity, float heading_max_velocity, float drive_settle_error, float drive_settle_time, float drive_timeout);
  void drive_distance_velocity(float distance, float heading, float drive_max_velocity, float heading_max_velocity, float drive_settle_error, float drive_settle_time, float drive_timeout, float drive_kp, float drive_ki, float drive_kd, float drive_starti, float heading_kp, float heading_ki, float heading_kd, float heading_starti);
